...
## 第三十五阶段：个人资料编辑和账户管理功能（完成）
- [x] 分析当前的个人资料页面
  - [x] 查看UserProfile.tsx的实现
  - [x] 检查当前显示的用户信息
  - [x] 确定需要添加的字段
- [x] 扩展数据库schema
  - [x] 添加avatar字段（头像URL）
  - [x] 添加bio字段（个人签名）
  - [x] 添加biography字段（个人资料/简介）
  - [x] 运行数据库迁移
- [x] 创建个人资料编辑表单
  - [x] 头像上传和预览
  - [x] 昵称编辑
...
## 第三十六阶段：全局付费功能开关（进行中）
- [ ] 设计功能开关机制
  - [ ] 创建systemConfig表存储全局配置
  - [ ] 添加paymentEnabled字段（是否启用付费功能）
  - [ ] 添加其他功能开关字段
  - [ ] 运行数据库迁移
- [ ] 实现后端配置管理
  - [ ] 创建system.getConfig路由获取全局配置
  - [ ] 创建admin.updateConfig路由更新配置（仅管理员）
  - [ ] 添加配置缓存机制
  - [ ] 添加权限验证
- [ ] 修改个人资料页面
  - [ ] 根据paymentEnabled隐藏VIP特权卡片
  - [ ] 根据paymentEnabled隐藏升级到VIP按钮
  - [ ] 所有用户显示为免费用户
  - [ ] 隐藏订阅状态相关信息
- [ ] 修改其他付费相关模块
  - [ ] 隐藏或禁用付费相关的按钮
...
## 第三十六阶段：全局付费功能开关（完成）
- [x] 设计功能开关机制
  - [x] 创建systemConfig表存储全局配置
  - [x] 添加paymentEnabled字段（是否启用付费功能）
  - [x] 运行数据库迁移
- [x] 实现后端配置管理
  - [x] 创建system.getConfig路由获取全局配置
  - [x] 创建admin.updateConfig路由更新配置（仅管理员）
  - [x] 添加权限验证
- [x] 修改个人资料页面
  - [x] 根据paymentEnabled隐藏VIP特权卡片
  - [x] 根据paymentEnabled隐藏升级到VIP按钮
  - [x] 所有用户显示为免费用户
  - [x] 隐藏订阅状态相关信息
  - [x] 根据配置显示/隐藏邀请功能
- [x] 测试和优化
...
## 第三十七阶段：管理员后台（完成）
- [x] 设计管理员后台结构
  - [x] 规划后台路由结构（/admin/dashboard、/admin/settings、/admin/users）
  - [x] 设计后台布局（侧边栏导航）
  - [x] 确定管理功能模块
- [x] 实现后端管理API
  - [x] 创建adminRouter.ts
  - [x] 实现getUsers路由（分页查询用户）
  - [x] 实现getUserStats路由（用户统计）
  - [x] 实现getAllConfigs路由（获取所有配置）
  - [x] 实现updateConfig路由（更新配置）
  - [x] 实现deleteConfig路由（删除配置）
  - [x] 实现getSystemStats路由（系统统计）
  - [x] 添加权限验证（仅管理员可访问）
- [x] 构建管理员后台UI
  - [x] 创建AdminLayout组件（侧边栏导航）
  - [x] 创建顶部导航栏
  - [x] 实现权限检查（非管理员重定向）
  - [x] 响应式设计（移动端支持）
- [x] 实现系统配置管理页面
...
- [x] 实现第一个用户自动成为管理员逻辑
  - [x] 修改upsertUser函数
  - [x] 检查是否是第一个用户
  - [x] 如果是第一个用户，设置role为admin
  - [x] 如果不是第一个用户，设置role为user
- [x] 实现管理员添加管理员功能
  - [x] 创建setUserRole API
  - [x] 添加权限验证（仅管理员可操作）
  - [x] 防止管理员自己降级
